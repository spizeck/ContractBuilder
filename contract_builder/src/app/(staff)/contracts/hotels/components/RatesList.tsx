...
import { getRates, deleteRate } from '@/app/(staff)/contracts/_lib/ratesRepo'
...
import { Rate, RoomCategory, Season } from '@/app/(staff)/contracts/_types'
...
export default function RatesList ({
  ...
  // const [isAdding, setIsAdding] = useState(false) // Removed Add Rate as rates are automatically added.
  ...
  // Removed Add Rate as rates are automatically added.
  // const handleAddRate = () => {
  //   setIsAdding(true);
  // };
