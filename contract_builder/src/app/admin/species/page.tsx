...
import {addSpecies, deleteSpecies, getSpecies, updateSpecies} from "@/services/species";
...
export default function SpeciesPage() {
  ...
  return (
    <Box p={6}>
      <Heading size="lg" mb={4}>Manage Species</Heading>
      ...
      {loading ? (
        ...
        <>
          <Button colorScheme="teal" mb={4} onClick={() => setShowForm(true)}>Add Species</Button>
                ...
                <Tr key={species.id}>
                  ...
                  <Td>
                    <HStack spacing={2}>
                      ...
                      <Button size="sm" colorScheme="red" onClick={() => handleDelete(species.id)}>Delete</Button>
                    </HStack>
                  </Td>
                </Tr>
              ))}
